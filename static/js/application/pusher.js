document.addEventListener("DOMContentLoaded", function(event) { 
  ...
  // new eployer
  $('.new_banner').submit(function(event) {

      $.ajax({
          url : "create_new_banner_",
          type : "POST",
          ...
          success : function(json) {            
            ...
            if (message == 'success') {
              // $('.new_banner')[0].reset();
              // window.location.href = "successfully registered";
              $(".create-message-success").html("Banner has been successfully uploaded");
              setTimeout(function() {
                $(".create-message-success").fadeOut().empty();
              }, 5000);

            }else if (message == 'failed') {

              $(".create-message-error").html("Banner upload failed please try again !!");
              setTimeout(function() {
                $(".create-message-error").fadeOut().empty();
              }, 5000);
            }
            else{

              console.log(message);
              $(".create-message-error").html(message);
              // alert(message);
              setTimeout(function() {
                $(".create-message-error").fadeOut().empty();
              }, 5000);
    ...
    // new eployer
  $('.new_story').submit(function(event) {

      $.ajax({
          url : "create_new_story_",
          type : "POST",
          data:new FormData(this),
          processData:false,
          contentType:false,
          ...
          success : function(json) {            
            ...
            if (message == 'success') {
              // $('.new_banner')[0].reset();
              // window.location.href = "successfully registered";
              $(".create-message-success").html("Story has been successfully created");
              setTimeout(function() {
                $(".create-message-success").fadeOut().empty();
              }, 5000);
              ...
              $(".create-message-error").html("Story creation failed please try again !!");
              setTimeout(function() {
                $(".create-message-error").fadeOut().empty();
              }, 5000);
            }
  ...
  // new eployer
  $('.update_banner').submit(function(event) {

      $.ajax({
          url : "update_banner_details",
          type : "POST",
          data:new FormData(this),
          processData:false,
          contentType:false,
          ...
          success : function(json) {            
            ...
            if (message == 'success') {
              // $('.new_banner')[0].reset();
              // window.location.href = "successfully registered";
              $(".create-message-success").html("Banner has been successfully updated");
              setTimeout(function() {
                $(".create-message-success").fadeOut().empty();
              }, 5000);
              ...
              $(".create-message-error").html("Banner update failed please try again !!");
              setTimeout(function() {
                $(".create-message-error").fadeOut().empty();
              }, 5000);
            }
      ...
      $.ajax({
          ...
          success : function(json) {            
            ...
            if (message == 'success') {
              // $('.new_banner')[0].reset();
              // window.location.href = "successfully registered";
              $(".create-message-success").html("Story has been successfully updated");
              setTimeout(function() {
                $(".create-message-success").fadeOut().empty();
              }, 5000);
              ...
              $(".create-message-error").html("Story update failed please try again !!");
              setTimeout(function() {
                $(".create-message-error").fadeOut().empty();
              }, 5000);
            }
