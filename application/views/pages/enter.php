                    ...
                    <div class="uk-width-large-2-3 uk-hidden-medium uk-hidden-small">
                        <div class="login_page_info uk-height-1-1" style="background-image: url('<?php echo base_url(); ?>static/img/others/sabri-tuzcu-331970.jpg')">
                            <div class="info_content">
                                <h1 class="heading_b">DJ-ANDIE SITE ADMINISTRATOR</h1>
                                Welcome to DjAndie website administrator account. Use you staff account to be able to proceed to perform administrative duties based on your account permission. If you do not have an account, create one but you will have to request the Space owner to approve your account to be able to use it. Thank you!!!
                            </div>
                        </div>
                    </div>
