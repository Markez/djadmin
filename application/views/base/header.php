...
<head>
    ...
    <!-- weather icons -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>static/assets/weather-icons/css/weather-icons.min.css" media="all">
    <!-- metrics graphics (charts) -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>static/assets/metrics-graphics/dist/metricsgraphics.css">
    <!-- chartist -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>static/assets/chartist/dist/chartist.min.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>static/css/themes/themes_combined.min.css" media="all">
        <!-- dropify -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>static/skins/dropify/css/dropify.css">
                                ...
                                <div class="uk-grid uk-dropdown-grid">
                                    <div class="uk-width-2-3">
                                        <div class="uk-grid uk-grid-width-medium-1-3 uk-margin-bottom uk-text-center">
                                            ...
                                            <a href="banners" class="uk-margin-top">
                                                <i class="material-icons md-36 md-color-cyan-600">supervised_user_circle</i>
                                                <span class="uk-text-muted uk-display-block">Main Banners</span>
                                            </a>
                                            <a href="stories" class="uk-margin-top">
                                                <i class="material-icons md-36 md-color-red-600">&#xE85C;</i>
                                                <span class="uk-text-muted uk-display-block">Recent Stories</span>
                                            </a>
                                        </div>
                                    </div>
...
<!--                 <li title="Finance">
                ...
                <li title="Job Seekers Area">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">&#xE85C;</i></span>
                        <span class="menu_title">Main Banners</span>
                    </a>
                    <ul>
                        <li><a href="create_banner">Create</a></li>
                        <li><a href="banners">All Banners</a></li>
<!--                         <li><a href="suspended_employees">Suspended</a></li>
                ...
                <li title="Job Posts Area">
                    <a href="#">
                        ...
                        <span class="menu_title">Recent Stories</span>
                    </a>
                    <ul>
                        <li><a href="create_story">Create</a></li>
...
<!--                         <li><a href="open_jobs">Open</a></li>
                ...
                <li title="Help Documentations">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">&#xE8C0;</i></span>
                        <span class="menu_title">Support</span>
                    </a>
                    <ul>
                        <li><a href="supportStaff">Staff</a></li>
<!--                         <li><a href="supportEmployers">Banners</a></li>
                        <li><a href="supportEmployees">Recent Stories</a></li> -->
