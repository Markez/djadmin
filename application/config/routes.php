...
$route['dashboard'] = 'main/createStaff';
$route['staffs'] = 'main/allStaff';
$route['banners'] = 'main/allEmployees';
$route['employers'] = 'main/allEmployers';
$route['get_banner'] = 'main/singleBanner';
$route['get_story'] = 'main/singleStory';
...
$route['banner_update'] = 'crud/updateBanner';
$route['story_update'] = 'crud/updateStory';
...
$route['update_banner_status'] = 'crud/updateBannerStatus';
$route['update_story_status'] = 'crud/updateStoryStatus';
...
$route['create_new_banner_'] = 'crud/createBanner';
$route['create_new_story_'] = 'crud/createStory';
$route['create_new_employer_'] = 'crud/createEmployer';
// main updates 
$route['update_employer_details'] = 'crud/updatingEmployer';
$route['update_banner_details'] = 'crud/updatingBanner';
$route['update_story_details'] = 'crud/updatingStory';
